//
//  AllPostsCollectionViewController.swift
//  Test Reader
//
//  Created by Stepan Chegrenev on 13.01.17.
...
private let reuseIdentifier = "AllPostsCollectionViewCell"

class AllPostsCollectionViewController: UICollectionViewController {
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        ...
        allPosts?.sort(by: { $0.postsPubDate!.compare($1.postsPubDate! as Date) == .orderedDescending })
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        let item = self.allPosts![indexPath.row]
    ...
    {
        self.performSegue(withIdentifier: "AllPostCollectionViewCellSegue", sender: allPosts?[indexPath.row])
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        if segue.identifier == "AllPostCollectionViewCellSegue"
        {
